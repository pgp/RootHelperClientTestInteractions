...
if __name__ == '__main__':
	# rclient = remote_client_url_download(serverHost="v.gd",serverPort=443,downloadPath='/dev/shm/vgd.html') # mandatory SNI
	...
	# rclient = remote_client_url_download(serverHost="u.nu",serverPort=443,downloadPath='/dev/shm/unu.html')
	rclient = remote_client_url_download(serverHost="cloudflare.com",serverPort=443,downloadPath='/dev/shm/cloudflare.html') # HTTP 301
	# rclient = remote_client_url_download(serverHost="www.cloudflare.com",serverPort=443,downloadPath='/dev/shm/www_cloudflare.html')
	if rclient is None:
		sys.exit(-1)
	rclient.close()
